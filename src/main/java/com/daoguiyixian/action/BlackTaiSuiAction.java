...
public class BlackTaiSuiAction extends AbstractGameAction {
    ...
    public BlackTaiSuiAction(AbstractCreature target, DamageInfo info, int[] baseDamage) {
        /* 33 */
        this.info = info;
        /* 34 */
...
//                    addToBot((AbstractGameAction) new HealAction(this.p, this.p, base[0]));
                    ...
                    this.addToBot(new DrawCardAction(this.p, 2));
                    /*    */
                } else {
                    this.p.hand.moveToExhaustPile(this.p.hand.getBottomCard());
