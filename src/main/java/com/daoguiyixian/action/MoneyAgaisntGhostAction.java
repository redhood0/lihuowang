...
public class MoneyAgaisntGhostAction extends AbstractGameAction {
    ...
    public MoneyAgaisntGhostAction(AbstractCreature target,int blocknum) {
        /* 33 */
        this.info = info;
        /* 34 */
...
//                    addToBot((AbstractGameAction) new HealAction(this.p, this.p, base[0]));
                    ...
                    this.addToBot(new GainBlockAction(p, p, this.blocknum));
                    /*    */
                } else {
                    this.p.hand.moveToExhaustPile(this.p.hand.getBottomCard());
                   /*    */
