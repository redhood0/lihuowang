...
public class DoubleChop extends CustomCard {
    public static final String ID = ModHelper.MakePath(DoubleChop.class.getSimpleName());;
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    private static final String NAME = cardStrings.NAME;
    private static final String IMG_PATH = "lihuowangResources/img/cards/DoubleChop.png";
