...
import com.daoguiyixian.power.HuoWoPower;
...
public class HuoWoZhenJin extends CustomCard {
    public static final String ID = ModHelper.MakePath(HuoWoZhenJin.class.getSimpleName());

    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    private static final String NAME = cardStrings.NAME;
    private static final String IMG_PATH = "lihuowangResources/img/cards/HuoWoZhenJin.png";
...
//        this.addToBot(new WuxingPower(p, this.magicNumber));
        this.addToBot(new ApplyPowerAction(p, p, new HuoWoPower(p, this.magicNumber), this.magicNumber));
