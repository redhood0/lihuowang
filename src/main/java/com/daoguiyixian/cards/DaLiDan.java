...
//0费加攻-消耗
public class DaLiDan extends CustomCard {
    public static final String ID = ModHelper.MakePath(DaLiDan.class.getSimpleName());

    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    private static final String NAME = cardStrings.NAME;
    private static final String IMG_PATH = "lihuowangResources/img/cards/DaLiDan.png";
