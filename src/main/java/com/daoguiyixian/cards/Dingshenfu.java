...
public class Dingshenfu extends CustomCard {
    public static final String ID = ModHelper.MakePath(Dingshenfu.class.getSimpleName());

    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    private static final String NAME = cardStrings.NAME;
    private static final String IMG_PATH = "lihuowangResources/img/cards/Dingshenfu.png";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        if(m.type != AbstractMonster.EnemyType.BOSS){
            this.addToTop(new StunMonsterAction(m,p,1));
